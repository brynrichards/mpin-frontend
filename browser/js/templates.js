(function() {
    ...
    mpin.template['landing'] = ['<!-- Home/Top Nav Bar -->',
        '<div id="header">',
        '    <div id="mpinLogo"></div>',
        '</div> ',
        '',
    ...
    mpin.template['accounts-panel'] = ['<div class="mpinLists" >',
        ...
        '	<div class="mpinArrowUp mpPointer" id="mpin_pinpad_show"></div>',
        '</div>',
        '',
        '',
        '',
    ...
    mpin.template['login'] = ['<div class="mpinHeader">',
        ...
        '',
        '<div class="mpinIdentityRow">',
        '	<div class="mpinArrowDown mpPointer" id="mpin_identity"></div>',
        '	<div class="mpinIdentity mpLeft20" id="mpinUser"></div>',
        '</div>',
        '',
