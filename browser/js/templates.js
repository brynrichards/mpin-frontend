(function() {
    ...
    mpin.template['setup'] = ['<div class="mpinHeader">',
        ...
        '		</div>',
        '		',
        '		<div class="mpinInputIn mpin75width" id="mpin_input_text">',
        '			<i id="mpin_help_pinpad"></i>',
        '				<span class="mpinInputText">',
        '					CREATE YOUR M-PIN:<br>',
        '					CHOOSE 4 DIGITS',
        '				</span>',
        '		</div>',
        '		',
        ...
        '    <div class="mpin-pre-row">',
        '        <div class="mpin-row mpin-bottom">',
        '            <button class="mpinPadBtn mpinPadBtnClear" data-value="clear" id="mpin_clear">',
        '                clear',
        '            </button>',
        '            <button class="mpinPadBtn" data-value="0">',
        '                0',
        '            </button>',
        '            <button class="mpinPadBtn mpinPadBtnLogin" data-value="go" id="mpin_setup">',
        '                setup',
        '            </button>',
        '        </div>',
        '    </div>',
