(function() {
    mpin.template = {};
    mpin.template['access-denied'] = ['<!-- Home/Top Nav Bar -->',
        '',
        '<header id="topNav">',
        ...
        '      <div class="congrats">',
        '        <%= hlp.text("accessdenied_header") %>',
        '      </div>',
        '',
        '      <div class="identityBodyText">',
        '          <p>',
        '              <%= hlp.text("accessdenied_text") %> <span style="color: red;"> <%=  email %> </span> <%= hlp.text("accessdenied_text_cont") %>',
        '          </p>',
        '          <p>',
        '      </div>',
        '  </div>',
        ...
        '          <span class="btnLabel"><%= hlp.text("accessdenied_btn") %></span>',
        '      </div>',
        '  </div> ',
        '',
        '</div>',
    ...
    mpin.template['delete-panel'] = ['<div id="identityContainer">',
        '',
        '  <div class="identityMainText">',
        '    <div class="mp_container">',
    ...
    mpin.template['helphub-index'] = ['This is the index html of the helphub.'].join('');
    ...
    mpin.template['identity-not-active'] = ['<!-- User section -->',
        '',
        '<header id="header">',
        '  <div id="menuIcon"></div>',
        '  <div id="mpinLogo"></div>',
    ...
    mpin.template['reactivate-panel'] = ['<div id="identityContainer">',
        '',
        '  <div class="identityMainText">',
        '    <div class="mp_container">',
        '        <div class="mp_headerFrame">',
    ...
    mpin.template['user-settings'] = ['<div id="identityContainer">',
        '',
        '  <div class="identityMainText">',
        '    <div class="mp_container">',
        '        <div id="mp_accountContent" class="mp_content"></div>',
