(function() {
    ...
    mpin.template['home_mobile'] = ['<div id="homeIcon">',
        ...
        '        <span class="iconArrow"></span>',
        '        <span class="btnLabel btnLabelArrow"><%=hlp.text( "home_button_authenticateMobile") %></span>',
        '    </div>',
    ...
    mpin.template['home'] = ['<div id="header">',
        ...
        '        <span class="iconArrow"></span>',
        '        <span class="btnLabel btnLabelArrow"><%=hlp.text("home_button_authenticateBrowser") %></span>',
        '    </div>',
        '    <div class="mpinBtn" id="mpin_setup">',
        '        <span class="iconArrow"></span>',
        '        <span class="btnLabel btnLabelArrow"><%=hlp.text("home_button_setupBrowser") %></span>',
        '    </div>       ',
        '</div>',
        '<div id="mpinFooter">',
        '    <div id="homeBtn"></div>',
